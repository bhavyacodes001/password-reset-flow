      ...
      <div className="d-flex justify-content-center">
        <Card className="glass-card" style={{ maxWidth: "440px", width: "100%" }}>
          <Card.Body className="p-4 p-md-5">
            ...
            {error && (
              <Alert variant="danger" className="text-center py-2">{error}</Alert>
            )}
            ...
            <Form onSubmit={handleSubmit}>
              <Form.Group className="mb-3 animate-in animate-in-delay-1">
                ...
                <Form.Control
                  ...
                  onChange={(e) => setEmail(e.target.value)} required size="lg" className="py-2"
                />
              </Form.Group>

              <Form.Group className="mb-2 animate-in animate-in-delay-2">
                <Form.Label>Password</Form.Label>
                <InputGroup>
                  <Form.Control
                    type={showPassword ? "text" : "password"} placeholder="Enter your password"
                    value={password} onChange={(e) => setPassword(e.target.value)}
                    required size="lg" className="py-2"
                  />
              ...
              <div className="text-end mb-4 animate-in animate-in-delay-2">
                <Link to="/forgot-password" className="fw-medium" style={{ fontSize: "0.9rem" }}>
                  Forgot Password?
                </Link>
              </div>
